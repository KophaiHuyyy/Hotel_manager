...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['edit_id'])) {
        ...
        if (isset($_FILES['cover_img']) && $_FILES['cover_img']['error'] === UPLOAD_ERR_OK) {
            ...
            $targetDir = 'C:/Users/Quang Huy/Documents/HelloPHP/QLKhachsan/'; // Replace with your desired upload directory
        ...
        if (isset($_FILES['cover_img']) && $_FILES['cover_img']['error'] === UPLOAD_ERR_OK) {
            $targetDir = 'C:/Users/Quang Huy/Documents/HelloPHP/QLKhachsan/';
            $imageName = basename($_FILES['cover_img']['name']);
            $targetFile = $targetDir . $imageName;
